...
describe('insecurity', () => {
  ...
  describe('hash', () => {
    ...
    it('returns MD5 hash for any input string', () => {
      expect(insecurity.hash('***REMOVED***')).to.equal('0192023a7bbd73250516f069df18b500')
  ...
  describe('hmac', () => {
    ...
    it('returns SHA-256 HMAC with "pa4qacea4VK9t9nGv7yZtwmj" as salt any input string', () => {
      expect(insecurity.hmac('***REMOVED***')).to.equal('6be13e2feeada221f29134db71c0ab0be0e27eccfc0fb436ba4096ba73aafb20')
