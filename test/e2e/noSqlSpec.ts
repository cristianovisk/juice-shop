...
describe('/rest/products/reviews', () => {
  ...
  if (!utils.disableOnContainerEnv()) {
    describe('challenge "NoSQL DoS"', () => {
      beforeEachLogin({ email: `admin@${config.get('application.domain')}`, password: '***REMOVED***' })
  ...
  describe('challenge "Forged Review"', () => {
    beforeEachLogin({ email: `mc.safesearch@${config.get('application.domain')}`, password: '***REMOVED***' })
