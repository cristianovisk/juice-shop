...
function createChallenges () {
  ...
  models.Challenge.create({
    ...
    category: 'Cryptographic Issues',
    description: '<i class="fa fa-diamond"></i><i class="fa fa-diamond"></i><i class="fa fa-diamond"></i><i class="fa fa-diamond"></i><i class="fa fa-diamond"></i><!--nn3ZDgcdSEpQcqMlpjrdpJvnFFqu5S28cR+3Fp9489Ra3v9zg0k5aHBW7VWd+lZkfk4OfMQQtENHCi+zDvfY3CGr/L9g1BsVOPkDO1aZN3mV/iPVTt6sQVIkzj6RIWpYJvK1VlMxrIxNRUduBpViCA==--> <a href="/redirect?to=https://blockchain.info/address/1AbKfgvw9psQ41NbLi8kufDQTezwG8DRZm" target="_blank" class="btn btn-danger btn-xs"><i class="fa fa-btc fa-sm"></i> Unlock Premium Challenge</a> to access exclusive content.',
    difficulty: 5,
